                    ...
                    {activeMode === 'brd' && (
                        <div style={{ flex: 1, padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px', overflowY: 'auto' }}>
                            ...
                            >
                                ...
                                <p style={{ margin: 0, fontWeight: '500', fontSize: '0.95rem' }}>Drag & drop BRD file here</p>
                                <span style={{ fontSize: '0.75rem', color: '#888', marginTop: '4px' }}>Supports .pdf, .docx, .txt</span>
                            </div>
