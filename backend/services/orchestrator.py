    ...
    async def run_gap_analysis(self, document_id: str, answers: list = None, enabled_modules: list = None):
        ...
        try:
            ...
            try:
                ...
                pii_report = await self.guard_agent.detect_pii(raw_text)
                ...
                # Apply Masking
                masked_text = await self.guard_agent.mask_pii(raw_text)
    ...
    async def run_functional_spec_generation(self, document_id: str, tech_context: str = None):
        ...
        try:
            ...
            try:
                ...
                dna_vault = {
                    "TECH_STACK": await self.context_agent.get_dna(db, "TECH_STACK"),
                    "USER_PREFERENCES": await self.context_agent.get_dna(db, "PREFERENCES"),
                    "GLOSSARY": await self.context_agent.get_dna(db, "GLOSSARY")
                }
