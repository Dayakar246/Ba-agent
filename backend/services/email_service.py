...
class EmailService:
    ...
    async def send_approval_email(self, recipient: str, subject: str, body: str):
        message = {
            "content": {
                "subject": subject,
                "html": body,
    ...
    async def send_approval_notification(self, subject: str, body: str, custom_recipient: str = None):
        ...
        try:
            await self.send_approval_email(recipient, subject, body)
        except Exception as e:
