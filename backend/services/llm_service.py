...
class LLMService:
    def __init__(self):
        ...
        self.azure_key_2 = os.getenv("AZURE_OPENAI_KEY_2") or os.getenv("OPENAI_KEY") or self.azure_key
        ...
        self.azure_embedding_key = os.getenv("AZURE_OPENAI_EMBEDDING_KEY", self.azure_key)
        ...
        self.kimi_key = os.getenv("KIMI_OPENAI_KEY")
